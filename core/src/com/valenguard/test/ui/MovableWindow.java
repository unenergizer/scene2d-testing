 ...
 * @author Nathan Sweet
 */
public class MovableWindow extends Table {
...
//    boolean drawTitleTable;
    ...
    public MovableWindow(Skin skin) {
        this(skin.get(MovableWindow.WindowStyle.class));
        setSkin(skin);
    }

    public MovableWindow(Skin skin, String styleName) {
        this(skin.get(styleName, WindowStyle.class));
        setSkin(skin);
    }

    public MovableWindow(WindowStyle style) {
...
//    }
    ...
    /**
     * The style for a window, see {@link MovableWindow}.
     *
     * @author Nathan Sweet
     */
